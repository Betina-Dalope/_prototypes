...
var globalPeaks;
function startAnimation(peaks) {
  var peaksIndex = 0; //position in array
  var stepIndex = 0; //number of times step() was called
  var interval = 500; // ms
  ...
  function step() {
      ...
      if ((interval * stepIndex) == (peaks[peaksIndex].timestamp * 1000)) {
        console.log((interval * stepIndex), (peaks[peaksIndex].timestamp * 1000));
        peaksIndex++;
      }
...
function getPeaks(data) {
  ...
  console.log(parts, data[0].length)
